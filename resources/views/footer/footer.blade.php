...
<div class="mt-5 p-4 bg-dark text-white text-center">
  <p>This is Footer @copyright {{ date('Y') }}</p>
</div>
-->
<div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <p>
                            <i class="fa fa-map-marker"></i> Leipzig,street, Leipzig, Germany - 560077555
                        </p>
                    </div>
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-phone"></i> +49 XXX-XXX-XXXX
                        </a>
                    </div>
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> xxxxxx@gmail.com
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; copyright {{ date('Y') }} - company name. All rights reserved.</p>
                </div>
                <div class="col-md-4">
